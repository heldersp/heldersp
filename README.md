...
- Profissional em transição de carreira, aos 31 anos decidi migrar totalmente para T.I., pois o mundo da tecnologia sempre me fascinou e também por se tratar de uma área que me desperta interesse e obsessão em aprofundar conhecimentos e habilidades, agora como profissional.  
- Atualmente cursando Bacharelado em Sistemas de Informação no Centro Universitário Fundação Santo André. Ao longo do curso me aprofundarei em algumas linguagens como PHP, C, JAVA, Python, dentre outras. Vou disponibilizando projetos e aprendizados aqui no Git conforme minha curva de aprendizagem ao longo dos cursos. Na plataforma Alura estou me dedicando à linguagem C# e desmembrando o .NET framework nas horas vagas. 
